_G.CustomColors = "Cyan"--Can use Brick Color or RGB: Color.fromRGB(0,0,0)
_G.AlreadyLoad = true
spawn(function()
...
repeat
  wait(0.3)
    ...
    game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatStart:FireServer(game.Workspace.FriendlyNPCs["Korin BEANS"])
    wait(0.3)
    game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatAdvance:FireServer({"k"})
    wait(0.3)
     game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatAdvance:FireServer({"k"})
    wait(0.3)
game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatAdvance:FireServer({tostring(BeansType)}) 
    wait(0.3)
    game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatAdvance:FireServer({"k"})
    wait(0.3)
    game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatAdvance:FireServer({tostring(BeansNumber)})
    wait(0.3)
    game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatAdvance:FireServer({'k'})
    wait(0.35)
game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatAdvance:FireServer({tostring(BeansColor)})
    wait(0.35)
game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatAdvance:FireServer({'k'})
    wait(0.3)
game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatAdvance:FireServer({'Use Zenni'})
    wait(0.3)
